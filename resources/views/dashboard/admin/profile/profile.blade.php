    ...
    <div class="p-0">
        <div class="space-y-10">
            ...
            @if (Laravel\Fortify\Features::canUpdateProfileInformation())
                <div class="p-6 rounded-lg shadow-sm bg-gray-50 dark:bg-slate-800 dark:border dark:border-slate-700">
            ...
            @if (Laravel\Jetstream\Jetstream::hasAccountDeletionFeatures())
                <div class="p-6 rounded-lg shadow-sm bg-red-50 dark:bg-red-900/20 dark:border dark:border-red-800">
                    <h3 class="mb-4 text-lg font-semibold text-red-600 dark:text-red-400">Hapus Akun</h3>
